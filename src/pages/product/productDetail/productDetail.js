    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="cm-mlr-02" onTouchStart={()=>this.closeBox()}>
                    <div className="cm-flex cm-ai-c cm-border-bottom-ddd cm-ptb-02 cm-fs-020">
                        <img src={this.state.item.publishUserAvatar} alt="" className="cm-img-08 cm-mr-02"/>
                        <div>
                    ...
                    <div className="cm-ptb-02 cm-fs-026">
                        ...
                        <div className="cm-c-333 cm-ptb-02">{this.state.item.productDesc}</div>
                    </div>
                    <div>
                    ...
                    <div className="cm-pt-02">
                        <div className="detail-line">
                            <span className="cm-mr-02">点赞</span><span>{this.state.praiseList.length}</span>
                        </div>
                    ...
                    <div className="cm-pt-02">
                        <div className="detail-line"><span
                            className="cm-mr-02">留言</span><span>{this.state.commentList.length}</span></div>
                        <div className="cm-flex cm-ai-c cm-ptb-02">
                                    ...
                                    return (
                                        ...
                                        <div className="cm-flex cm-jc-sb cm-ai-c">
                                            <div className="cm-flex cm-ai-c">
                                                <img src={item.fromUserAvatar} alt="" className="cm-img-04 cm-border-radius-half cm-mr-02"/>
                ...
                {this.state.isShowComment?<div className="cm-bottom-position cm-bc-white">
                        <textarea ref="textarea" className="cm-border-ddd cm-border-radius-10 cm-mr-02 cm-flex-1 cm-p-02" name="" id="" cols="30" rows="1" placeholder="看对就留言，问问更多细节"></textarea>
                        ...
                        <div className="cm-flex cm-ai-c cm-jc-sb detail-bottom cm-jc-sb">
                            <div className="cm-flex cm-ai-c">
                                <div className="cm-flex-column cm-ai-c cm-jc-c cm-mr-02">
                                    <img
                                ...
                                <div className="cm-flex-column cm-jc-c cm-ai-c cm-mlr-02">
